...
const ResetPassword = (props) => {
	...
	const handleSendEmail = async () => {
		...
		try {
			...
			setEmailConfirmed({
				confirmation: true,
				imageAddress: require("../../assets/green-check.png"),
			});
			setModalText("Please check your email accout for password reset email.");
			setModalStatus(true);
		} catch (err) {
			setEmailConfirmed({
				confirmation: false,
				imageAddress: require("../../assets/black.png"),
			});
			setModalStatus(true);
							...
							>
								<View style={styles.modalContainer}>
									<Image
										...
										source={emailConfirmed.imageAddress}
									...
									<CustomButton
										...
										text="OK"
										onPress={() => {
											if (emailConfirmed.confirmation) {
						...
						<View style={styles.buttonContainer}>
							{disableButton ? (
								...
								<CustomButton
									...
									disabled={!authState.inputValidities.email}
								/>
							)}
						</View>
					</View>
